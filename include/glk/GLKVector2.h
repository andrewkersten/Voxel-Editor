...
extern "C" {
	...
	static __inline GLKVector2 GLKVector2Make(float x, float y);
	static __inline GLKVector2 GLKVector2MakeWithArray(float values[2]);

	static __inline GLKVector2 GLKVector2Negate(GLKVector2 vector);

	static __inline GLKVector2 GLKVector2Add(GLKVector2 vectorLeft, GLKVector2 vectorRight);
	static __inline GLKVector2 GLKVector2Subtract(GLKVector2 vectorLeft, GLKVector2 vectorRight);
	static __inline GLKVector2 GLKVector2Multiply(GLKVector2 vectorLeft, GLKVector2 vectorRight);
	static __inline GLKVector2 GLKVector2Divide(GLKVector2 vectorLeft, GLKVector2 vectorRight);

	static __inline GLKVector2 GLKVector2AddScalar(GLKVector2 vector, float value);
	static __inline GLKVector2 GLKVector2SubtractScalar(GLKVector2 vector, float value);
	static __inline GLKVector2 GLKVector2MultiplyScalar(GLKVector2 vector, float value);
	static __inline GLKVector2 GLKVector2DivideScalar(GLKVector2 vector, float value);

	/*
	Returns a vector whose elements are the larger of the corresponding elements of the vector arguments.
	*/
	static __inline GLKVector2 GLKVector2Maximum(GLKVector2 vectorLeft, GLKVector2 vectorRight);
	/*
	Returns a vector whose elements are the smaller of the corresponding elements of the vector arguments.
	*/
	static __inline GLKVector2 GLKVector2Minimum(GLKVector2 vectorLeft, GLKVector2 vectorRight);

	/*
	Returns true if all of the first vector's elements are equal to all of the second vector's arguments.
	*/
	static __inline bool GLKVector2AllEqualToVector2(GLKVector2 vectorLeft, GLKVector2 vectorRight);
	/*
	Returns true if all of the vector's elements are equal to the provided value.
	*/
	static __inline bool GLKVector2AllEqualToScalar(GLKVector2 vector, float value);
	/*
	Returns true if all of the first vector's elements are greater than all of the second vector's arguments.
	*/
	static __inline bool GLKVector2AllGreaterThanVector2(GLKVector2 vectorLeft, GLKVector2 vectorRight);
	/*
	Returns true if all of the vector's elements are greater than the provided value.
	*/
	static __inline bool GLKVector2AllGreaterThanScalar(GLKVector2 vector, float value);
	/*
	Returns true if all of the first vector's elements are greater than or equal to all of the second vector's arguments.
	*/
	static __inline bool GLKVector2AllGreaterThanOrEqualToVector2(GLKVector2 vectorLeft, GLKVector2 vectorRight);
	/*
	Returns true if all of the vector's elements are greater than or equal to the provided value.
	*/
	static __inline bool GLKVector2AllGreaterThanOrEqualToScalar(GLKVector2 vector, float value);

	static __inline GLKVector2 GLKVector2Normalize(GLKVector2 vector);

	static __inline float GLKVector2DotProduct(GLKVector2 vectorLeft, GLKVector2 vectorRight);
	static __inline float GLKVector2Length(GLKVector2 vector);
	static __inline float GLKVector2Distance(GLKVector2 vectorStart, GLKVector2 vectorEnd);

	static __inline GLKVector2 GLKVector2Lerp(GLKVector2 vectorStart, GLKVector2 vectorEnd, float t);

	/*
	Project the vector, vectorToProject, onto the vector, projectionVector.
	*/
	static __inline GLKVector2 GLKVector2Project(GLKVector2 vectorToProject, GLKVector2 projectionVector);
