...
extern "C" {
	...
	*/
	static __inline GLKMatrix4 GLKMatrix4Make(float m00, float m01, float m02, float m03,
	...
	*/
	static __inline GLKMatrix4 GLKMatrix4MakeAndTranspose(float m00, float m01, float m02, float m03,
		float m10, float m11, float m12, float m13,
		float m20, float m21, float m22, float m23,
		float m30, float m31, float m32, float m33);
	...
	*/
	static __inline GLKMatrix4 GLKMatrix4MakeWithArray(float values[16]);

	/*
	m[3], m[7], and m[11] correspond to the translation values tx, ty, and tz, respectively.
	*/
	static __inline GLKMatrix4 GLKMatrix4MakeWithArrayAndTranspose(float values[16]);

	/*
	row0, row1, and row2's last component should correspond to the translation values tx, ty, and tz, respectively.
	*/
	static __inline GLKMatrix4 GLKMatrix4MakeWithRows(GLKVector4 row0,
		GLKVector4 row1,
		GLKVector4 row2,
		GLKVector4 row3);
	...
	*/
	static __inline GLKMatrix4 GLKMatrix4MakeWithColumns(GLKVector4 column0,
		GLKVector4 column1,
		GLKVector4 column2,
		GLKVector4 column3);
	...
	*/
	static __inline GLKMatrix4 GLKMatrix4MakeWithQuaternion(GLKQuaternion quaternion);

	static __inline GLKMatrix4 GLKMatrix4MakeTranslation(float tx, float ty, float tz);
	static __inline GLKMatrix4 GLKMatrix4MakeScale(float sx, float sy, float sz);
	static __inline GLKMatrix4 GLKMatrix4MakeRotation(float radians, float x, float y, float z);

	static __inline GLKMatrix4 GLKMatrix4MakeXRotation(float radians);
	static __inline GLKMatrix4 GLKMatrix4MakeYRotation(float radians);
	static __inline GLKMatrix4 GLKMatrix4MakeZRotation(float radians);

	/*
	Equivalent to gluPerspective.
	*/
	static __inline GLKMatrix4 GLKMatrix4MakePerspective(float fovyRadians, float aspect, float nearZ, float farZ);

	/*
	Equivalent to glFrustum.
	*/
	static __inline GLKMatrix4 GLKMatrix4MakeFrustum(float left, float right,
	...
	*/
	static __inline GLKMatrix4 GLKMatrix4MakeOrtho(float left, float right,
		float bottom, float top,
		float nearZ, float farZ);
	...
	*/
	static __inline GLKMatrix4 GLKMatrix4MakeLookAt(float eyeX, float eyeY, float eyeZ,
	...
	*/
	static __inline GLKMatrix3 GLKMatrix4GetMatrix3(GLKMatrix4 matrix);
	/*
	Returns the upper left 2x2 portion of the 4x4 matrix.
	*/
	static __inline GLKMatrix2 GLKMatrix4GetMatrix2(GLKMatrix4 matrix);
	...
	*/
	static __inline GLKVector4 GLKMatrix4GetRow(GLKMatrix4 matrix, int row);
	/*
	...
	*/
	static __inline GLKVector4 GLKMatrix4GetColumn(GLKMatrix4 matrix, int column);

	/*
	GLKMatrix4SetRow expects that the vector for row 0, 1, and 2 will have a translation value as its last component.
	Valid row values range from 0 to 3, inclusive.
	*/
	static __inline GLKMatrix4 GLKMatrix4SetRow(GLKMatrix4 matrix, int row, GLKVector4 vector);
	/*
	...
	Valid column values range from 0 to 3, inclusive.
	*/
	static __inline GLKMatrix4 GLKMatrix4SetColumn(GLKMatrix4 matrix, int column, GLKVector4 vector);

	static __inline GLKMatrix4 GLKMatrix4Transpose(GLKMatrix4 matrix);

	//TODO: documentation
	__declspec(dllexport) GLKMatrix4 GLKMatrix4Invert(GLKMatrix4 matrix, bool *isInvertible);

	//TODO: documentation
	__declspec(dllexport) GLKMatrix4 GLKMatrix4InvertAndTranspose(GLKMatrix4 matrix, bool *isInvertible);

	static __inline GLKMatrix4 GLKMatrix4Multiply(GLKMatrix4 matrixLeft, GLKMatrix4 matrixRight);

	static __inline GLKMatrix4 GLKMatrix4Add(GLKMatrix4 matrixLeft, GLKMatrix4 matrixRight);
	static __inline GLKMatrix4 GLKMatrix4Subtract(GLKMatrix4 matrixLeft, GLKMatrix4 matrixRight);

	static __inline GLKMatrix4 GLKMatrix4Translate(GLKMatrix4 matrix, float tx, float ty, float tz);
	static __inline GLKMatrix4 GLKMatrix4TranslateWithVector3(GLKMatrix4 matrix, GLKVector3 translationVector);
	/*
	The last component of the GLKVector4, translationVector, is ignored.
	*/
	static __inline GLKMatrix4 GLKMatrix4TranslateWithVector4(GLKMatrix4 matrix, GLKVector4 translationVector);

	static __inline GLKMatrix4 GLKMatrix4Scale(GLKMatrix4 matrix, float sx, float sy, float sz);
	static __inline GLKMatrix4 GLKMatrix4ScaleWithVector3(GLKMatrix4 matrix, GLKVector3 scaleVector);
	/*
	The last component of the GLKVector4, scaleVector, is ignored.
	*/
	static __inline GLKMatrix4 GLKMatrix4ScaleWithVector4(GLKMatrix4 matrix, GLKVector4 scaleVector);

	static __inline GLKMatrix4 GLKMatrix4Rotate(GLKMatrix4 matrix, float radians, float x, float y, float z);
	static __inline GLKMatrix4 GLKMatrix4RotateWithVector3(GLKMatrix4 matrix, float radians, GLKVector3 axisVector);
	/*
	The last component of the GLKVector4, axisVector, is ignored.
	*/
	static __inline GLKMatrix4 GLKMatrix4RotateWithVector4(GLKMatrix4 matrix, float radians, GLKVector4 axisVector);

	static __inline GLKMatrix4 GLKMatrix4RotateX(GLKMatrix4 matrix, float radians);
	static __inline GLKMatrix4 GLKMatrix4RotateY(GLKMatrix4 matrix, float radians);
	static __inline GLKMatrix4 GLKMatrix4RotateZ(GLKMatrix4 matrix, float radians);

	/*
	Assumes 0 in the w component.
	*/
	static __inline GLKVector3 GLKMatrix4MultiplyVector3(GLKMatrix4 matrixLeft, GLKVector3 vectorRight);
	/*
	Assumes 1 in the w component.
	*/
	static __inline GLKVector3 GLKMatrix4MultiplyVector3WithTranslation(GLKMatrix4 matrixLeft, GLKVector3 vectorRight);
	/*
	Assumes 1 in the w component and divides the resulting vector by w before returning.
	*/
	static __inline GLKVector3 GLKMatrix4MultiplyAndProjectVector3(GLKMatrix4 matrixLeft, GLKVector3 vectorRight);

	/*
	Assumes 0 in the w component.
	*/
	static __inline void GLKMatrix4MultiplyVector3Array(GLKMatrix4 matrix, GLKVector3 *vectors, size_t vectorCount);
	/*
	Assumes 1 in the w component.
	*/
	static __inline void GLKMatrix4MultiplyVector3ArrayWithTranslation(GLKMatrix4 matrix, GLKVector3 *vectors, size_t vectorCount);
	/*
	Assumes 1 in the w component and divides the resulting vector by w before returning.
	*/
	static __inline void GLKMatrix4MultiplyAndProjectVector3Array(GLKMatrix4 matrix, GLKVector3 *vectors, size_t vectorCount);

	static __inline GLKVector4 GLKMatrix4MultiplyVector4(GLKMatrix4 matrixLeft, GLKVector4 vectorRight);

	static __inline void GLKMatrix4MultiplyVector4Array(GLKMatrix4 matrix, GLKVector4 *vectors, size_t vectorCount);
