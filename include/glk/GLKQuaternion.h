...
extern "C" {
	...
	*/
	static __inline GLKQuaternion GLKQuaternionMake(float x, float y, float z, float w);

	/*
	vector represents the imaginary values.
	*/
	static __inline GLKQuaternion GLKQuaternionMakeWithVector3(GLKVector3 vector, float scalar);

	/*
	values[0], values[1], and values[2] represent the imaginary values.
	*/
	static __inline GLKQuaternion GLKQuaternionMakeWithArray(float values[4]);

	/*
	Assumes the axis is already normalized.
	*/
	static __inline GLKQuaternion GLKQuaternionMakeWithAngleAndAxis(float radians, float x, float y, float z);
	/*
	Assumes the axis is already normalized.
	*/
	static __inline GLKQuaternion GLKQuaternionMakeWithAngleAndVector3Axis(float radians, GLKVector3 axisVector);
	...
	*/
	...
	static __inline GLKQuaternion GLKQuaternionAdd(GLKQuaternion quaternionLeft, GLKQuaternion quaternionRight);
	static __inline GLKQuaternion GLKQuaternionSubtract(GLKQuaternion quaternionLeft, GLKQuaternion quaternionRight);
	static __inline GLKQuaternion GLKQuaternionMultiply(GLKQuaternion quaternionLeft, GLKQuaternion quaternionRight);

	GLKQuaternion GLKQuaternionSlerp(GLKQuaternion quaternionStart, GLKQuaternion quaternionEnd, float t);

	static __inline float GLKQuaternionLength(GLKQuaternion quaternion);

	static __inline GLKQuaternion GLKQuaternionConjugate(GLKQuaternion quaternion);
	static __inline GLKQuaternion GLKQuaternionInvert(GLKQuaternion quaternion);
	static __inline GLKQuaternion GLKQuaternionNormalize(GLKQuaternion quaternion);

	static __inline GLKVector3 GLKQuaternionRotateVector3(GLKQuaternion quaternion, GLKVector3 vector);
	...
	*/
	static __inline GLKVector4 GLKQuaternionRotateVector4(GLKQuaternion quaternion, GLKVector4 vector);
